...
- Override httpcore5.version to 5.4.3 (replace 5.3.6 managed by Spring Boot) to fix CVE-2026-54428
...
- Added org.apache.tomcat.embed:tomcat-embed-core as managed dependency with version 10.1.55 (replace 10.1.54) to fix CVEs
